...
Conv2D_1 =  click.prompt('Enter Conv2D_1 (32, 64)', type=int)
Conv2D_2 = click.prompt('Enter Conv2D_2 (64, 128)', type=int)
Conv2D_3 = click.prompt('Enter Conv2D_3 (128, 512)', type=int)
Conv2D_4 = click.prompt('Enter Conv2D_4 (128, 512)', type=int)
DropOut_1 = click.prompt('Enter DropOut_1 (decimal pct)', type=float)
DropOut_2 = click.prompt('Enter DropOut_2 (decimal pct)', type=float)
...
model = Sequential([
    ...
    MaxPooling2D(),
    Conv2D(Conv2D_4, 3, padding='same', activation='relu'),
    MaxPooling2D(),
    Flatten(),
...
# %% 
if click.confirm('Run Model Eval?', default=False):
    print()